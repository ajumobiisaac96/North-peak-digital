...
**Task B (Lighthouse, live URL):** [docs/CHANGELOG.md](docs/CHANGELOG.md) —
Performance 98, Accessibility 100. Screenshot: [docs/lighthouse-scores.png](docs/lighthouse-scores.png),
